---
# Example announcement. Set `hidden: false` (or delete the line) to publish it.
...
date: 2026-05-08
# Shown on the announcements list and home page. Keep it to a sentence or two.
...
<!-- Anything below the frontmatter is the full announcement body, written in Markdown. An announcement with a body gets its own page and is linked from the list. -->
